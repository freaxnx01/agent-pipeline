---
description: List and triage parked Forgejo issues (🧊 parked) — list | unpark <n> | repark <n> "<reason>" | review
...
read and follow `~/.claude/commands/fj/route.md` (i.e. run `/fj:route <n>`).
