...
## [1.13.0](https://github.com/freaxnx01/agent-workflow/releases/tag/v1.13.0) - 2026-08-25

### Fixed

- **report:** Surface an error_* subtype even when is_error is false

## [1.12.0](https://github.com/freaxnx01/agent-workflow/releases/tag/v1.12.0) - 2026-08-25

### Added

- **pipeline:** Expose the claude process wall-clock as an input

## [1.11.1](https://github.com/freaxnx01/agent-workflow/releases/tag/v1.11.1) - 2026-08-03

### Fixed

- **classify-task:** Don't escalate to claude-* models for non-claude agents
